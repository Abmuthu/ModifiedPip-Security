...
class TestHash(unittest.TestCase):
  ...
  def _do_unsupported_algorithm(self, library):
    self.assertRaises(ssl_commons__exceptions.UnsupportedAlgorithmError, ssl_crypto__hash.digest, 'bogus')
  ...
  def test_unsupported_digest_algorithm_and_library(self):
    self.assertRaises(ssl_commons__exceptions.UnsupportedAlgorithmError, ssl_crypto__hash.digest,
                      'sha123', 'hashlib')
    self.assertRaises(ssl_commons__exceptions.UnsupportedAlgorithmError, ssl_crypto__hash.digest,
                      'sha123', 'pycrypto')
    
    self.assertRaises(ssl_commons__exceptions.UnsupportedLibraryError, ssl_crypto__hash.digest,
                      'sha256', 'badlib')
